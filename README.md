...
- **Mama AI** — a real AI chat assistant (see below) with a polished, friendly interface: gradient bubbles, typing indicator, and suggested-question chips. It's instructed to actually answer maternal-health questions (nutrition, symptoms, breastfeeding, exercise, emotional wellbeing, general medication/supplement info, etc.) rather than reflexively deflecting to "ask your doctor" — while still never diagnosing her specific situation or giving her an exact personal medication dose. If something sounds like a real emergency or genuinely needs a real person, the AI flags it and a "message your care team" button appears right under that response, one tap from starting a real conversation with a doctor or health worker. There's also an always-visible link at the bottom of the chat to reach a real provider any time, regardless of what the AI says.
